...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions):
        ...
        # predictions = predictions[predictions.pred_classes==3]
        # import pdb
        # pdb.set_trace()

        # predictions = predictions[torch.sum(predictions.pred_masks[:,349:659,866:1000], dim=(1,2))>0]
        ...
        if predictions.has("pred_masks"):
            ...
            #     masks[i, 300:600 ,1354:1500  ]  =  False
            #     # masks[i, 700:1080, 1200:1920] = False
            # # masks = mask_new == 10
            ret_masks = masks
        ...
        for i in range(num_instances):
            ...
            if labels is not None:
                ...
                self.draw_text(
                    ...
                    # labels[i].split(' ')[0][0] + labels[i].split(' ')[0][-1]+ labels[i].split(' ')[1],
                    text_pos,
                    color=lighter_color,
